...
```
 Parallel analysis, as shown in the above scree plot indicated that the number of factors is 4 and the number of component is 2. Considering this result, the factor analysis will be conducted with 4 factors. 
