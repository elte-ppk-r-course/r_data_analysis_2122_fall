---
title: "Assignent Factor Analyisis"
...
```{r}
animal <-read.csv("assignments/data/assignment_5_dataset.csv")
```
...
```
 Parallel analysis, as shown in the above scree plot indicated that the number of factors is 3 and the number of component is 2. Considering this result, the factor analysis will be conducted with 4 factors. 
...
```
Factor analysis was done with factoring method of minimum residual since the disribution assumption (normality mutivariate is not met). Oblimin rotate factor was used as they allow inter-factor correlation with the number of factor specief 4.
since, i use factor loading cut point is 0.45 due to the number of participant is 154 (based on some resources if the partipants araoun 150, the the cut point of factor loading is .45). After revieweing the factor loading, there are 8 items below the cut point, those are: ar1, ar3, ar8, ar16, ar18,ar21, ar22, ar28. there are also 9 items cross loading (ar10, ar17, ar19, ar20,ar21,ar24, ar27), so those items will excluded from the scales. 
...
```
sort(facan_newresult$communality, decreasing = T)
     ar13       ar5      ar15       ar2      ar12       ar9       ar6       ar4      ar26      ar23      ar11       ar7      ar14      ar25 
0.9250130 0.9051441 0.6991632 0.6422802 0.6022560 0.4914105 0.4713765 0.4632562 0.4015383 0.3934382 0.3716142 0.3683937 0.3242609 0.3011510 


The results show that there are no item have communality score below 0.5, so all new items in the simple sacle will be included. 
...
ar26  0.34  0.37            
                ...
                MR2  MR3  MR4  MR1
SS loadings    2.24 1.76 1.67 0.41
Proportion Var 0.16 0.13 0.12 0.03
Cumulative Var 0.16 0.29 0.41 0.43
...
-2.21141 -0.69090  0.06627  0.27019  2.17779 

Coefficients:
                Estimate Std. Error t value Pr(>|t|)    
(Intercept)      2.90746    0.06836  42.529   <2e-16 ***
animal_use      -0.03386    0.09034  -0.375    0.708    
animal_research  0.06383    0.12754   0.500    0.618    
animal_rights    0.13406    0.13102   1.023    0.308    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.8428 on 148 degrees of freedom
  (2 observations deleted due to missingness)
Multiple R-squared:  0.03287,	Adjusted R-squared:  0.01326 
F-statistic: 1.677 on 3 and 148 DF,  p-value: 0.1746

Linear regreesion analysis indicates that attitude towards animal rights is the best predictor of how liberal a person is (B=0.13; p<0.001)
