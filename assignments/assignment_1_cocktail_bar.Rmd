...
#Töröltem a zárójeles adatokat is az ingredients-ből
library(stringr)
...
```{r}
#összegzem a sorted_ingr változót, így 60-at kapok
summary(sorted_ingr)
...
```{r}
#A 10 leggyakoribb, de többet lekértem, mert sok volt a döntetlen.
...
```{r}
#Mivel az összetevők soronként vannak, és egy koktélhoz így több sor is tartozik, megnéztem, hogy melyik koktél név a leggyakoribb. 6 egyformán gyakori nevet találtam.
...
#a végső cocktail név lista ismétlések nélkül
...
#Koktélok azonosítása = 55, ennyi sor kell
unique(cocktail_data$name)

#Hozzávalók azonosítása = 61, ennyi oszlop kell
