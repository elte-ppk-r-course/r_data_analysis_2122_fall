...
*The fitted model on database A predicts 33.7% of the pain's variance in dataset B (adj R^2 = 0.337).*

*Compared to the modelA fitted on dataset A it seems to be higher than the marginal (0.316), but lower than the conditional (0.435).*
