...
#reorder, nem sikerült fct_ordert használni, mert a 'Number of expeditions' változó nem létezik
...
#az eredeti képen láthatóan nem minden ponthoz került név, de a feladat leírásból nem derült ki, hogy ez mi alapján történt
```
