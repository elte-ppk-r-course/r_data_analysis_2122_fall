...
*It is odd, because ever since now the order of the bars were correct. Although I have not changed anything in the code it is not the same as the example (or exact order) anymore. I would love to know why, so any feedback is appreciated*
